...
public class Cuadro {
	...
	public Cuadro() {
        ...
        /**
         * Método para darle un color, un ancho y alto a cada cuadro
         * que posteriormente se integra para crear la figura indicada
         */
	...
	public Cuadro setUbicacion(int baseX, int baseY) {		
        ...
        /**
         * Método para obtener la sección donde se ubica
         * cada casilla de la figura, para posteriormente
         * colorear el área
         */
	public Cuadro setUbicacion(int i, int j, int baseX, int baseY) {
        ...
        /**
         * Método para clonar un cuadro previamente creado
         * para después manipularlo sin alterar el original
         * se hace una copia seteando los mismos valores
         */
