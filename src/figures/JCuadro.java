...
public class JCuadro extends Figura {

	public JCuadro() {
		super(Constantes.J_CUADRO, EnumFigure.L_SQUARE);

		this.setUbicacionCuadro(Constantes.COLUMNAS / 3, 0);
	}
	
	public JCuadro(Color color, int baseX, int baseY, int tamanioCuadroX, int tamanioCuadroY) {
		super(color, baseX, baseY, tamanioCuadroX, tamanioCuadroY, EnumFigure.L_SQUARE);
         ...
         * cada rotación se debe contemplar todos los casos que ocurre al 
         * rotarla, para ello, se valida todas las opciones y se cambia la 
	...
	public LinkedList<Cuadro> rotarElemento(Cuadro[][] board) {
        ...
        /**
         * Método para crear la figura j pero rotada a la 
         * derecha, para eso con el this.addCuadro agregamos
         * un cuadro que asemejará la patita y posteriormente
         * con el ciclo agregamos otros tres cuadros en forma
         * horizontal pero en la fila posterior al cuadro 
         * agregado
         * 
         * Aún no se colorean, simplemente se agrega los 
         * cuadros que formarán la figura en la posición adecuada
         * 
         */
	@Override
	public void setUbicacionCuadro(int indexI, int indexJ) {
        ...
        /**
         * Método para generar la nueva posición de una figura
         * respecto a la actual, los cambios se harán en sentido de las
         * manecillas del reloj, empezando a validar por arriba, siguiente
         * derecha, abajo y finalmente izquierda
         */
	@Override
